...
// Save pcd
extern const string fileDirectory = "/home/administrator/reac_ws/data/loam_converted_map/tmp_";
...
// history key frames (history submap for loop closure)
extern const float historyKeyframeSearchRadius = 7.0; // key frame that is within n meters from current pose will be considerd for loop closure
extern const int   historyKeyframeSearchNum = 51; // 2n+1 number of hostory key frames will be fused into a submap for loop closure
extern const float historyKeyframeFitnessScore = 0.5; // the smaller the better alignment
